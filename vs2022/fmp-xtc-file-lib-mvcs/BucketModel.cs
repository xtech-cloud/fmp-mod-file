...
namespace XTC.FMP.MOD.File.LIB.MVCS
{
    ...
    public class BucketModel : BucketBaseModel
    {
        ...
        /// 完整名称
        /// </summary>
        public const string NAME = "XTC.FMP.MOD.File.LIB.MVCS.BucketModel";
        ...
        public BucketModel(string _uid) : base(_uid)
        {
        }
        ...
        protected override void preSetup()
        {
            ...
            // 实例化直系状态
            Error err;
            status_ = spawnStatus<BucketStatus>(this.getUID() + ".Status", out err);
            if (0 != err.getCode())
            {
